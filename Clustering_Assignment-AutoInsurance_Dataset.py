...
Convert the categorical variables to numeric by using dummies
or label encoding and perform normalization techniques. 
The data set consists of details of customers related to their auto insurance. 
Refer to Autoinsurance.csv dataset.

Business Objective
Minimize : Claim Time
Maximaze : Customer Lifetime Value
...
Auto=pd.read_csv("C:\Data Set\AutoInsurance.csv")
